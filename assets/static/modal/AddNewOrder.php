<style>
    ...
    .modal_content_orders form input {
        font-size: 18px;
        font-weight: 500;
        width: 100%;
    ...
    .modal_content_orders form select {
        font-size: 18px;
        font-weight: 500;
        width: 100%;
        border: 3px solid var(--brd-clr);
    ...
    .modal_content_orders form button {
        font-weight: 500;
        color: var(--color-primary);
        font-size: 18px;
        width: 100%;
...
<div class="modal" id="mymodal">
    <div class="modal_content_orders">
        <form action="/profile/order" method="POST">
            ...
            <input name="id" id="id" style="display: none; color:rgba(0, 0, 0, 0);" value="<? echo $_SESSION["User"]["id"] ?>">
            <a class="btnss">
